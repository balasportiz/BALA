                            ...
                            {header.map((col, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {magic && (
                                            <span 
                                                className="ml-1 text-[10px] bg-indigo-200 text-indigo-800 px-1 rounded cursor-help"
                                                title={
                                                    col.toLowerCase().includes('fixed_date') 
                                                        ? "This column contains the standardized dates in DD-MM-YYYY format." 
                                                        : col.toLowerCase().includes('calculated_age') 
                                                            ? "This column contains the calculated age based on the fixed date and the target date." 
                                                            : "This column was generated by the tool."
                                                }
                                            >
                                                MAGIC
                                            </span>
